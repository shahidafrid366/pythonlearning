"""
! Update Tuples
* Tuples are unchangeable, meaning that you can't change, add, or remove items once the tuple is
* created. But there are some workarounds:
...
? This will throw error: NameError: name 'thistuple' is not defined
