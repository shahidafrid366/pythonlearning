...
? Example: change the second item in list
...
? Example 2: Change the second value by replacing it with two new values:
    thislist = ["apple", "banana", "cherry"]
    thislist[1:3] = ["Papaya", "blackcurrant", "watermelon"]
    print(thislist)

    ? Output: ['apple', 'Papaya', 'blackcurrant', 'watermelon']
* What happened: "banana" and "cherry" got removed. In their place, 3 new elements were
* inserted. The list grew from length 3 → 4.
